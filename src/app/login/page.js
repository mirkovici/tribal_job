        ...
        <div className={styles.content}>
          ...
          <div className={styles.formCard}>
            ...
            <div className={styles.socialButtons}>
              ...
              {/* LinkedIn Button */}
              <button onClick={handleLinkedInLogin} className={styles.socialButton}>
            ...
            <p className={styles.signupText}>
              ...
              <Link href="/signup" className={styles.signupLink} onClick={handleSignupClick}>
                Sign Up
              </Link>
            </p>
          </div>
          ...
          <div className={styles.marketingMessage}>
            ...
            <p className={styles.marketingText}>
              Sign in to explore top opportunities in the gaming and iGaming industry.
            </p>
            <p className={styles.marketingText}>
              ...
              {!resetSuccess ? (
                ...
                <div className={styles.successContent}>
                  ...
                  <p className={styles.successText}>
                    We&apos;ve sent a password reset link to <span className={styles.successEmail}>{resetEmail}</span>
                  </p>
                  <button
                    onClick={() => {
                      setShowForgotPassword(false);
