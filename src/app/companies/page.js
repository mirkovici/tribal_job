...
export default function CompaniesPage() {
  ...
  <path d="M5.66665 12.3333C5.66665 12.5101 5.59641 12.6797 5.47138 12.8047C5.34636 12.9298 5.17679 13 4.99998 13C4.82317 13 4.6536 12.9298 4.52858 12.8047C4.40355 12.6797 4.33331 12.5101 4.33331 12.3333C4.33331 12.1565 4.40355 11.9869 4.52858 11.8619C4.6536 11.7369 4.82317 11.6667 4.99998 11.6667C5.17679 11.6667 5.34636 11.7369 5.47138 11.8619C5.59641 11.9869 5.66665 12.1565 5.66665 12.3333Z" fill="white"/>
          ...
          <div className={styles.filterGroup}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  <path d="M8.00004 7.99999C9.4728 7.99999 10.6667 6.80608 10.6667 5.33332C10.6667 3.86056 9.4728 2.66666 8.00004 2.66666C6.52728 2.66666 5.33337 3.86056 5.33337 5.33332C5.33337 6.80608 6.52728 7.99999 8.00004 7.99999Z" fill="white" fillOpacity="0.4"/>
  <path d="M13.3334 14V12.6667C13.3334 11.2522 12.7715 9.89563 11.7713 8.89544C10.7711 7.89525 9.41451 7.33334 8.00002 7.33334C6.58553 7.33334 5.22898 7.89525 4.22878 8.89544C3.22859 9.89563 2.66669 11.2522 2.66669 12.6667V14" fill="white" fillOpacity="0.4"/>
</svg>
            <select 
              className={styles.select}
              value={selectedSize}
